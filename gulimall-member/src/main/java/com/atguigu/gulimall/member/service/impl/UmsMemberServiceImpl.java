...
public class UmsMemberServiceImpl extends ServiceImpl<UmsMemberDao, UmsMemberEntity> implements UmsMemberService {
    ...
    public void register(MemberUserRegisterVo vo) {
        ...
        //设置默认等级
        UmsMemberLevelEntity levelEntity = memberLevelDao.selectOne(new QueryWrapper<UmsMemberLevelEntity>()
                .eq("default_status", 1));
    ...
    public void checkPhoneUnique(String phone) throws PhoneException {
        Long phoneCount = this.baseMapper.selectCount(new QueryWrapper<UmsMemberEntity>().eq("mobile", phone));
        if (phoneCount > 0) {
    ...
    public void checkUserNameUnique(String userName) throws UsernameException {
        Long usernameCount = this.baseMapper.selectCount(new QueryWrapper<UmsMemberEntity>().eq("username", userName));
        if (usernameCount > 0) {
