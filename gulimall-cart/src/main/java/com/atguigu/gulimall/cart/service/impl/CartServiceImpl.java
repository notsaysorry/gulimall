...
import com.atguigu.gulimall.cart.config.CartInterceptor;
...
public class CartServiceImpl implements CartService {
    ...
    @Override
    public CartItemVo addToCart(String skuId, Integer num) throws ExecutionException, InterruptedException {
        ...
        if (StringUtils.isEmpty(productRedisValue)) {
            ...
            CompletableFuture<Void> getSkuInfoFuture = CompletableFuture.runAsync(() -> {
                ...
                SkuInfoVo skuInfo = productSkuInfo.getData("pmsSkuInfo", new TypeReference<SkuInfoVo>() {});
                //数据赋值操作
     ...
     */
    @Override
    public void deleteIdCartInfo(String skuId) {
        BoundHashOperations<String, Object, Object> cartOps = getCartOps();
