...
public class CartController {
    ...
    public String checkItem(@RequestParam(value = "skuId") String skuId,
    ...
    public String countItem(@RequestParam(value = "skuId") String skuId,
    ...
    public String addToCartSuccessPage(@RequestParam("skuId") String skuId,
                                       Model model) {
